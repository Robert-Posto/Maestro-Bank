...
teste, fără obiect `Request` (vezi tests/test_budgets.py), iar fallback-ul
...
T: dict[str, dict[Language, str]] = {
    # Identice cu auth-service/exchange-service — aceleași chei/text,
    # folosite ca convenție de stil (fiecare serviciu validează JWT-ul
    # independent, defense in depth, vezi app/security.py), nu ca o
    ...
    "invalidBudgetId": {"ro": "ID de buget invalid.", "en": "Invalid budget ID."},
    "budgetNotFound": {"ro": "Bugetul nu există.", "en": "This budget does not exist."},
    "invalidSubscriptionId": {"ro": "ID de abonament invalid.", "en": "Invalid subscription ID."},
    "subscriptionNotFound": {"ro": "Abonamentul nu există.", "en": "This subscription does not exist."},
}
